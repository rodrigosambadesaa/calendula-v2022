...
public class AllergiesSearchActivity extends CalendulaActivity {
    ...
    private void setupSearchView() {
        ...
        ExpandableExtension<AbstractItem> expandableExtension = new ExpandableExtension<>();
        //expandableExtension.withOnlyOneExpandedItem(true);
        searchAdapter.addExtension(expandableExtension);
//        searchAdapter.withPositionBasedStateManagement(false);
        searchAdapter.withEventHook(new AllergenGroupItem.GroupExpandClickEvent());
