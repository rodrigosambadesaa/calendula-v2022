...
public class CalendulaJobCreator implements JobCreator {
    ...
    public Job create(String tag) {
        switch (tag) {
            ...
            case UpdateMedicationFromServiceJob.TAG:
                return new UpdateMedicationFromServiceJob();
            case GetExtraInfoFromServiceJob.TAG:
                return new GetExtraInfoFromServiceJob();
            default:
                return null;
        }
    }
