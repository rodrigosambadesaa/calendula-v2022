...
public class Routine {
    ...
    public static final String COLUMN_DAILY_EVENT = "DailyEvent";


    @DatabaseField(columnName = COLUMN_ID, generatedId = true)
    private Long id;

    @DatabaseField(columnName = COLUMN_TIME, persisterClass = LocalTimePersister.class, uniqueCombo = true)
    ...
    @DatabaseField(columnName = COLUMN_DAILY_EVENT)
    private RepeatType dailyEventType = RepeatType.TIME_OF_DAY;
    ...
    public RepeatType dailyEventType() {
        return dailyEventType;
    }

    public void setDailyEventType(RepeatType dailyEventType) {
