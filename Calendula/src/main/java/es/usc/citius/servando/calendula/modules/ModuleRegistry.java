...
public class ModuleRegistry {
    ...
    public enum ModuleConfig {
        PRODUCT(ModuleLists.STABLE_MODULES), CI(ModuleLists.UNSTABLE_MODULES), DEVELOP(ModuleLists.UNSTABLE_MODULES);
    ...
    private static class ModuleLists {
        private static final Class<?>[] STABLE_MODULES = new Class<?>[]{
                ...
                SetupDatabaseModule.class,
                ActiveMedsModule.class
        };
