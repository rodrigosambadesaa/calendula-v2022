...
class PrivacyPrefsFragment :
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        pinTimeoutPref?.let { pinTimeoutPref!!.summary = pinTimeoutPref!!.entry}
    ...
    override fun setFingerprintPrefEnabled(enabled: Boolean) {
        fingerprintPref?.let { fingerprintPref!!.isEnabled = enabled}
    }

    override fun setPINDependentPrefsEnabled(enabled: Boolean) {
        pinTimeoutPref?.let { pinTimeoutPref!!.isEnabled = enabled}
    }
