...
object NotificationHelper {
    ...
    fun createNotificationChannels(context: Context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val setupChannelName = context.getString(R.string.channel_setup_name)
            val setupChannelDesc = context.getString(R.string.channel_setup_description)
            ...
            setupChannel.description = setupChannelDesc


            // register the channels
            val notificationManager = context.getSystemService(NotificationManager::class.java)
            notificationManager.createNotificationChannels(listOf(medChannel, setupChannel, defaultChannel))
        }
    }
