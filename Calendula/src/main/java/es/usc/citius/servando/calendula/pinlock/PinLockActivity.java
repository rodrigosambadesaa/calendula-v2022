...
public class PinLockActivity extends CalendulaActivity {
        ...
        new MaterialStyledDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        SecurePrefBundle.INSTANCE.delete();
                        dialog.dismiss();
                        // important: use application context since activity is going to finish
                        LoginStateManager.getInstance().logout(PinLockActivity.this.getApplicationContext(), false);
                        finish();
                    }
                })
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupStatusBar(ContextCompat.getColor(this, R.color.healthcare_provider_dark));

        switch (action) {
            case ACTION_NEW_PIN:
                pinInputStateManager.setPinCompleteListener(new NewPinListener());
                promptMessage.setText(R.string.text_pinlock_new_prompt);
                setupToolbar(null, ContextCompat.getColor(this, R.color.healthcare_provider_dark));
                break;
