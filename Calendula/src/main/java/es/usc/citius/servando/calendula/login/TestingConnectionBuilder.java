...
/**
 * Connection builder for AppAuth that accepts HTTP connections,  not just HTTPS. Should only be used for development purposes.
 */
public final class TestingConnectionBuilder implements ConnectionBuilder {

    private static TestingConnectionBuilder theInstance = null;

    private static final String TAG = "TestingConnectionBuildr";
    ...
    private static final TrustManager[] ANY_CERT_MANAGER = new TrustManager[]{
            new X509TrustManager() {
                ...
                public void checkServerTrusted(X509Certificate[] certs, String authType, String host) {
                }
            }
    };
    ...
    private TestingConnectionBuilder() {
