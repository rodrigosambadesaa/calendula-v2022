...
//                mDescriptionTv.setText(p.getName());
    ...
    public void onAttach(Context context) {
        ...
        LogUtil.d(TAG, "Activity " + context.getClass().getName() + ", " + (context instanceof OnMedicineEditListener));
        // If the container activity has implemented
        // the callback interface, set it as listener
        if (context instanceof OnMedicineEditListener) {
            mMedicineEditCallback = (OnMedicineEditListener) context;
        }
...
//                searchButton.setVisibility(View.GONE);
    ...
    public void setupIcons(View root) {
        ...
        int size = 24;
        Drawable ic1 = IconUtils.icon(c, CommunityMaterial.Icon2.cmd_pencil, color, size, 4);
    ...
    private void setupStockViews() {
        ...
        IconicsDrawable resetDrawable = new IconicsDrawable(getContext(), CommunityMaterial.Icon2.cmd_reload)
                .iconOffsetXDp(2)
