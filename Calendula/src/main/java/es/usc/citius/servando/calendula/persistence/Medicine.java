...
public class Medicine implements Comparable<Medicine> {
    ...
    public static final String COLUMN_ACTIVE_MED_ID = "ActiveMedId";
    ...
    @DatabaseField(columnName = COLUMN_ACTIVE_MED_ID)
    private Long activeMedId;
    ...
    public static Medicine fromHomogeneousGroup(HomogeneousGroup g) {
        Medicine m = new Medicine();
        m.setHomogeneousGroup(String.valueOf(g.getHomogeneousGroupID()));
        m.setName(g.getName());
        Presentation pre = DBRegistry.instance().current().expectedPresentation(g.getName(), g.getName());
        m.setPresentation(pre != null ? pre : Presentation.PILLS);
        m.setDatabase(DBRegistry.instance().current().id());
        return m;
    }
    ...
    public boolean isFromActiveMed() {
