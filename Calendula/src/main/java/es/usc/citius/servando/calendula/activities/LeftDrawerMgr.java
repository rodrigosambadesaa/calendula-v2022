...
import es.usc.citius.servando.calendula.util.LocaleHelper;
...
public class LeftDrawerMgr implements Drawer.OnDrawerItemClickListener, AccountHeader.OnAccountHeaderListener {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        b.addDrawerItems(
                ...
                new PrimaryDrawerItem()
                        ...
                        .withIcon(IconUtils.icon(homeActivity, CommunityMaterial.Icon2.cmd_pill, R.color.black).alpha(110))
        ...
        b.addDrawerItems(
                ...
                new PrimaryDrawerItem()
                        ...
                        .withIcon(IconUtils.icon(homeActivity, CommunityMaterial.Icon2.cmd_settings, R.color.black).alpha(110))
                        .withIdentifier(SETTINGS));
        if (LoginStateManager.getInstance().isLoggedIn()) {
            b.addDrawerItems(new PrimaryDrawerItem()
                    .withName(R.string.drawer_logout_option)
                    .withIcon(IconUtils.icon(homeActivity, CommunityMaterial.Icon2.cmd_logout, R.color.black).alpha(110))
                    .withIdentifier(LOGOUT));
        } else {
            b.addDrawerItems(new PrimaryDrawerItem()
                    .withName(R.string.drawer_login_option)
                    .withIcon(IconUtils.icon(homeActivity, CommunityMaterial.Icon2.cmd_logout, R.color.black).alpha(110))
        ...
        b.addDrawerItems(
                ...
                new PrimaryDrawerItem()
                        ...
                        .withIcon(IconUtils.icon(homeActivity, CommunityMaterial.Icon2.cmd_information, R.color.black).alpha(110))
                        .withIdentifier(ABOUT),
                new DividerDrawerItem(),
                new LocaleHelper.LangDrawerItem(homeActivity)
                        .withIdentifier(LANG)
        );
    ...
    public boolean onItemClick(View view, int i, IDrawerItem iDrawerItem) {
        ...
        //TODO: use another method to identify the item.
        ...
        switch (identifier) {
            ...
            case ALLERGIES:
                ...
                break;
            case LOGOUT:
                onPagerPositionChange(homeActivity.getPagerPosition());
                showLogoutConfirmationDialog();
                break;
            case LOGIN:
                final Intent i1 = new Intent(homeActivity, LoginActivity.class);
                launchAndFinish(i1);
                drawer.setSelection(HOME, false);
                break;
            default:
    ...
    private void showLogoutConfirmationDialog() {
        new MaterialStyledDialog.Builder(homeActivity)
                .setHeaderColor(R.color.android_blue)
                .setIcon(IconUtils.icon(homeActivity, CommunityMaterial.Icon2.cmd_logout, R.color.white, 100))
                .withDialogAnimation(true)
                .setTitle(R.string.dialog_logout_title)
                .setDescription(R.string.dialog_logout_description)
                .setCancelable(true)
                .setPositiveText(homeActivity.getString(R.string.dialog_yes_option))
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    @Override
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        drawer.setSelection(HOME, false);
                        // important: use application context since activity is going to finish
                        LoginStateManager.getInstance().logout(homeActivity.getApplicationContext(), false);
                        homeActivity.finish();
                    }
                })
                .setNegativeText(homeActivity.getString(R.string.cancel))
    ...
    private void launchAndFinish(Intent i) {
        launchActivity(i);
        homeActivity.finish();
    }
