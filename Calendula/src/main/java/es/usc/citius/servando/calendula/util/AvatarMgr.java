...
public class AvatarMgr {
    ...
    static {
        ...
        map.put(AVATAR_1, R.drawable.ic_avatar1);
        map.put(AVATAR_2, R.drawable.ic_avatar2);
        map.put(AVATAR_3, R.drawable.ic_avatar3);
        map.put(AVATAR_4, R.drawable.ic_avatar4);
        map.put(AVATAR_5, R.drawable.ic_avatar5);
        map.put(AVATAR_6, R.drawable.ic_avatar6);
        map.put(AVATAR_7, R.drawable.ic_avatar7);
        map.put(AVATAR_8, R.drawable.ic_avatar8);
        map.put(AVATAR_9, R.drawable.ic_avatar9);
        map.put(AVATAR_10, R.drawable.ic_avatar10);
        map.put(AVATAR_11, R.drawable.ic_avatar11);
        map.put(AVATAR_12, R.drawable.ic_avatar12);
        map.put(AVATAR_13, R.drawable.ic_baby);
        map.put(AVATAR_14, R.drawable.ic_dog);
        map.put(AVATAR_15, R.drawable.ic_cat);
        map.put(DEFAULT_AVATAR, R.drawable.ic_avatar_default);
